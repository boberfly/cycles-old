...
#  endif
    ...
    if ((pass_filter & BAKE_FILTER_EMISSION) && (sd->flag & SD_EMISSION)) {
      ...
      path_radiance_accum_emission(kg, &L_sample, &state, NULL, throughput, emission, 0);
    }
...
#  endif
        ...
        kernel_path_indirect(kg, &indirect_sd, &emission_sd, &ray, throughput, &state, NULL, &L_sample);
